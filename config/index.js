...
const config = Object.freeze({
  ...
  BOT_GROUP_ACTIVATE_KEYWORD: env.BOT_GROUP_ACTIVATE_KEYWORD || "ai",
  ...
  OPENAI_COMPLETION_STOP_SEQUENCES: env.OPENAI_COMPLETION_STOP_SEQUENCES
    ? String(env.OPENAI_COMPLETION_STOP_SEQUENCES).split(",")
    : [" assistant:", " user:"],
  OPENAI_IMAGE_GENERATION_MODEL:
    env.OPENAI_IMAGE_GENERATION_MODEL || "dall-e-2",
  OPENAI_IMAGE_GENERATION_SIZE: env.OPENAI_IMAGE_GENERATION_SIZE || "256x256",
  OPENAI_IMAGE_GENERATION_QUALITY:
    env.OPENAI_IMAGE_GENERATION_QUALITY || "standard",
